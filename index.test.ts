...
test("add", t => {
    ...
    t.deepEqual(add(0, {units: 1, billionths: 999999999}), decimal({units: 1, billionths: 999999999}));
    t.deepEqual(add({units: 2, billionths: 999999999}, 0), decimal({units: 2, billionths: 999999999}));
...
test("subtract", t => {
    ...
    t.deepEqual(subtract(0, {units: 1, billionths: 999999999}), decimal({units: -1, billionths: -999999999}));
    t.deepEqual(subtract({units: 2, billionths: 999999999}, 0), decimal({units: 2, billionths: 999999999}));
...
test("multiply", t => {
    ...
    t.deepEqual(multiply({billionths: 23897}, {billionths: 715456512}), decimal({billionths: 17097}));
    t.deepEqual(multiply({billionths: 23898}, {billionths: 715456512}), decimal({billionths: 17098}));
    t.deepEqual(multiply({billionths: 24221}, {units: 6440}), decimal({billionths: 155983240}));
    t.deepEqual(multiply({billionths: 13137}, {units: 644953600}), decimal({units: 8472, billionths: 755443200}));
    t.deepEqual(multiply({billionths: 951910400}, 0), decimal(0));
    t.deepEqual(multiply({billionths: 503447552}, {billionths: 33662}), decimal({billionths: 16947}));
    t.deepEqual(multiply({billionths: 395509760}, {billionths: 512360448}), decimal({billionths: 202643558}));
    t.deepEqual(multiply({billionths: 202833920}, {units: 17273}), decimal({units: 3503, billionths: 550300160}));
    ...
    t.deepEqual(multiply({units: 22149}, {billionths: 465305600}), decimal({units: 10306, billionths: 53734400}));
    ...
    t.deepEqual(multiply({units: 517865472}, {billionths: 63370}), decimal({units: 32817, billionths: 134960640}));
    ...
    t.deepEqual(multiply({billionths: 32396}, {billionths: 567869440}), decimal({billionths: 18397}));
    t.deepEqual(multiply({billionths: 32397}, {billionths: 567869440}), decimal({billionths: 18397}));
    t.deepEqual(multiply({billionths: 32396}, {billionths: 567876876}), decimal({billionths: 18397}));
    t.deepEqual(multiply({billionths: 32397}, {billionths: 567876876}), decimal({billionths: 18398}));
    t.deepEqual(multiply({billionths: 878641152}, {billionths: 7436}), decimal({billionths: 6534}));
    t.deepEqual(multiply({billionths: 878641152}, {billionths: 567869440}), decimal({billionths: 498953459}));
    ...
    t.deepEqual(multiply({billionths: 878673548}, {billionths: 567869440}), decimal({billionths: 498971856}));
    t.deepEqual(multiply({billionths: 878673549}, {billionths: 567869440}), decimal({billionths: 498971856}));
    t.deepEqual(multiply({billionths: 878673548}, {billionths: 567876876}), decimal({billionths: 498978389}));
    t.deepEqual(multiply({billionths: 878673549}, {billionths: 567876876}), decimal({billionths: 498978390}));
    t.deepEqual(multiply({billionths: 878673550}, {billionths: 567876876}), decimal({billionths: 498978391}));
    t.deepEqual(multiply({billionths: 878673551}, {billionths: 567876876}), decimal({billionths: 498978391}));
    t.deepEqual(multiply({billionths: 878673552}, {billionths: 567876876}), decimal({billionths: 498978392}));
    t.deepEqual(multiply({billionths: 878673553}, {billionths: 567876876}), decimal({billionths: 498978392}));
...
test("floor", t => {
    ...
    t.deepEqual(floor({units: 45389, billionths: 500000000}), decimal({units: 45389, billionths: 0}));
    ...
    t.deepEqual(floor({units: -4539, billionths: -584928927}), decimal({units: -4540, billionths: 0}));
    t.deepEqual(floor({units: -45389, billionths: -500000000}), decimal({units: -45390, billionths: 0}));
    t.deepEqual(floor({units: 0, billionths: 343}, 8), decimal({units: 0, billionths: 340}));
    t.deepEqual(floor({units: 6225, billionths: 45683}, 6), decimal({units: 6225, billionths: 45000}));
    t.deepEqual(floor({units: 6225, billionths: 45683}, 7), decimal({units: 6225, billionths: 45600}));
    t.deepEqual(floor({units: 6225, billionths: 45683}, 8), decimal({units: 6225, billionths: 45680}));
    t.deepEqual(floor({units: 4539, billionths: 584928927}, 1), decimal({units: 4539, billionths: 500000000}));
    t.deepEqual(floor({units: 4539, billionths: 584928927}, 2), decimal({units: 4539, billionths: 580000000}));
    t.deepEqual(floor({units: 4539, billionths: 584928927}, 3), decimal({units: 4539, billionths: 584000000}));
    t.deepEqual(floor({units: 4539, billionths: 584928927}, 4), decimal({units: 4539, billionths: 584900000}));
    t.deepEqual(floor({units: 4539, billionths: 584978927}, 4), decimal({units: 4539, billionths: 584900000}));
    ...
    t.deepEqual(floor({units: -6225, billionths: -45683}, 6), decimal({units: -6225, billionths: -46000}));
    t.deepEqual(floor({units: -6225, billionths: -45683}, 7), decimal({units: -6225, billionths: -45700}));
    t.deepEqual(floor({units: -6225, billionths: -45683}, 8), decimal({units: -6225, billionths: -45690}));
    t.deepEqual(floor({units: -4539, billionths: -584928927}, 1), decimal({units: -4539, billionths: -600000000}));
    t.deepEqual(floor({units: -4539, billionths: -584928927}, 2), decimal({units: -4539, billionths: -590000000}));
    t.deepEqual(floor({units: -4539, billionths: -584928927}, 3), decimal({units: -4539, billionths: -585000000}));
...
test("round", t => {
    ...
    t.deepEqual(round({units: 45389, billionths: 500000000}), decimal({units: 45390, billionths: 0}));
    t.deepEqual(round({units: -0, billionths: -343}), decimal({units: 0, billionths: 0}));
    t.deepEqual(round({units: -6225, billionths: -45683}), decimal({units: -6225, billionths: 0}));
    t.deepEqual(round({units: -4539, billionths: -584928927}), decimal({units: -4540, billionths: 0}));
...
test("fromThousandths", t => {
    ...
    t.deepEqual(fromThousandths([0, 0, -1, 0, 0, 0]), decimal({units: -1, billionths: 0}));
    t.deepEqual(fromThousandths([123, 456, 789, 987, 654, 321]), decimal({units: 123456789, billionths: 987654321}));
